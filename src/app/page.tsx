...
export default function Home() {
  return (
    <>
      ...
      <section className="bg-[#e5d9f2] py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <AnimatedSection delay={0.4}>
              <p className="text-gray-700 mb-6 md:mb-8 max-w-2xl mx-auto text-base md:text-lg">
                Mantente al día con nuestras últimas creaciones artesanales y
                ofertas especiales
              </p>
            </AnimatedSection>
            <AnimatedSection delay={0.6}>
              <form className="max-w-md mx-auto flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7b6bc7] text-base"
                />
                <button
                  type="submit"
                  className="bg-[#6b5bb6] text-white px-6 py-3 rounded-lg hover:bg-[#5b4ba5] transition-colors font-medium text-base"
                >
                  Enviar
                </button>
              </form>
