          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-12 rounded-lg border border-gray-300 text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-[#6B5BB6] focus:border-transparent"
                placeholder="••••••••"
              />
              <button
                type="button"
